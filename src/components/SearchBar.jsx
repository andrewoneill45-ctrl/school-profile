    ...
    <div className="sb-wrap">
      <form className="sb" onSubmit={submit}>
        <div className={'sb-box ' + (focused ? 'sb-focus' : '')}>
          <svg className="sb-icon" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
